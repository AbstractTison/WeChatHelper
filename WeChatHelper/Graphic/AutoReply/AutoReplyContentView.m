...
@interface AutoReplyContentView () <NSTextFieldDelegate>
...
@implementation AutoReplyContentView
...
- (void)initSubviews {
    self.enableSpecificReplyBtn = ({
        NSButton *btn = [NSButton checkboxWithTitle:HelperLocalizedString(@"assistant.autoReply.enableSpecific") target:self action:@selector(clickEnableSpecificReplyBtn:)];
    ...
    self.selectSessionButton = ({
        NSButton *btn = [NSButton buttonWithTitle:HelperLocalizedString(@"assistant.autoReply.selectSpecific") target:self action:@selector(clickSelectSessionButton:)];
    ...
    self.enableRegexBtn = ({
        NSButton *btn = [NSButton checkboxWithTitle:HelperLocalizedString(@"assistant.autoReply.enableRegEx") target:self action:@selector(clickEnableRegexBtn:)];
    ...
    self.enableGroupReplyBtn = ({
        NSButton *btn = [NSButton checkboxWithTitle:HelperLocalizedString(@"assistant.autoReply.enableGroup") target:self action:@selector(clickEnableGroupBtn:)];
    ...
    self.enableSingleReplyBtn = ({
        NSButton *btn = [NSButton checkboxWithTitle:HelperLocalizedString(@"assistant.autoReply.enableSingle") target:self action:@selector(clickEnableSingleBtn:)];
    ...
    self.enableDelayBtn = ({
        NSButton *btn = [NSButton checkboxWithTitle:HelperLocalizedString(@"assistant.autoReply.delay") target:self action:@selector(clickEnableDelayBtn:)];
    ...
    self.delayField = ({
        ...
        textField.placeholderString = HelperLocalizedString(@"assistant.autoReply.timeUnit");
    ...
    self.autoReplyContentField = ({
        ...
        textField.placeholderString = HelperLocalizedString(@"assistant.autoReply.contentPlaceholder");
        textField.delegate = self;
    ...
    self.autoReplyLabel = ({
        NSString *text = [NSString stringWithFormat:@"%@: ",HelperLocalizedString(@"assistant.autoReply.content")];
    ...
    self.keywordTextField = ({
        ...
        textField.placeholderString = HelperLocalizedString(@"assistant.autoReply.keywordPlaceholder");
        textField.delegate = self;
    ...
    self.keywordLabel = ({
         NSString *text = [NSString stringWithFormat:@"%@: ",HelperLocalizedString(@"assistant.autoReply.keyword")];
        NSTextField *label = [NSTextField labelWithString:text];
    ...
    [self addSubviews:@[self.enableRegexBtn, self.enableGroupReplyBtn, self.enableSingleReplyBtn, self.autoReplyContentField, self.autoReplyLabel, self.keywordTextField, self.keywordLabel, self.delayField, self.enableDelayBtn, self.enableSpecificReplyBtn, self.selectSessionButton]];
}
...
- (void)viewDidMoveToSuperview {
    ...
    self.layer.backgroundColor = [RGBA(0xe3, 0xe3, 0xe3, 1.0) CGColor];
    self.layer.borderWidth = 1;
    self.layer.borderColor = [RGBA(0, 0, 0, 0.1) CGColor];
